...
function onPurchaseError(error) {
      console.log(error);
      alert("Error occurred: " + error.errorText + ", " + error.errorID + ", " error.errorSubCode);
}
...
function onGetPriceSuccess(data) {
    ...
    if (data.initialPeriod) {
        ...
        alert("Subscription Info: " + initialPeriod + "," + renewalPrice + "," + renewalPeriod + ", " error.errorSubCode);
    }
}
