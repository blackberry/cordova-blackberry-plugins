...
EXTRA_SRCVPATH+=$(WEBWORKS_DIR)/plugin/jpps/src/blackberry10/native/src/utils \
				$(WEBWORKS_DIR)/plugin/jpps/src/blackberry10/native/src/core \
				$(WEBWORKS_DIR)/plugin/jpps/src/blackberry10/native/src/plugin

EXTRA_INCVPATH+=$(WEBWORKS_DIR)/plugin/jpps/src/blackberry10/native/src/utils \
				$(WEBWORKS_DIR)/plugin/jpps/src/blackberry10/native/src/core \
				$(WEBWORKS_DIR)/plugin/jpps/src/blackberry10/native/src/plugin
